...
#import "ZWMenuTableViewCtrl.h"

@interface ZWFrostedRootViewCtrl () <UIGestureRecognizerDelegate> {
    CGFloat _distance;
...
@implementation ZWFrostedRootViewCtrl
...
//    _leftTableViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"ZWMenuTableViewCtrl"];
    _leftTableViewController = [[ZWMenuTableViewCtrl alloc] init];
...
//    _tabBarController = [self.storyboard instantiateViewControllerWithIdentifier:@"ZWBaseTabBarCtrl"];
    _tabBarController = [[ZWBaseTabBarCtrl alloc] init];
